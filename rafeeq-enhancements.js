...
(function () {
  ...
  const EX = {
    ...
    en: {
      ...
      mesh_t: "Nearby mutawwif mesh",
      mesh_d: "6 mutawwifs within 500 m notified",
  ...
  const MCIT_REQS = [
    ...
    { ar: "إدارة الحشود — مسار بديل + بث للمطوفين + لمّ الشمل", en: "Manage crowds — safe reroute + mutawwif broadcast + reunification", v: "missing" },
